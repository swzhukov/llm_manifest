...
Source: QW | Date: 2025-11-11T19:23:28.398000+08:00 | Messages: 34
...
class BitASRTranscriber:
    ...
    def check_status(self, task_id, max_attempts=60, delay=5):
        ...
        print(f"❌ Таймаут ожидания задачи {tas
        ...
        for attempt in range(1, max_attempts + 1):
            try:
                ...
                if response.status_code == 200:
                    ...
                    # КЛЮЧЕВОЕ ИСПРАВЛЕНИЕ: Обработка всех возможных
...
class BitASRTranscriber:
    ...
    def check_status(self, task_id, max_attempts=100, initial_
...
class BitASRTranscriber:
    ...
    def check_status(self, task_id, max_attempts=100, initial_delay=10, max_de
...
class BitASRTranscriber:
    ...
    def check_status(self, task_id, max_attemp
...
class BitASRTranscriber:
    ...
    def check_status(self, task_id, max_attempts=100, initial_delay=10, 
...
class BitASRTranscriber:
    ...
    def start_transcribing(self, file_path):
        ...
        file_to_upload = self.prepare_audio_file(file_path)
        file_size = os.path.getsize(file_to_upload)
        print(f"[{self.get_time()}] 📊 Размер файла: {file_size/1024/1024:.
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if task_data.get('task_id'):
                        print(f"[{self.get_time()}] ✅ Параметры рабочие: {
